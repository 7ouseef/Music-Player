...
public:
    ...
    bool update() {
        string filename = "D:\\Code\\DS\\DS Theory Project\\Text Files\\" + name + ".txt";
        fstream file;
    ...
    bool read(Hash& h) {
        string line, filename = "D:\\Code\\DS\\DS Theory Project\\Text Files\\" + name + ".txt";
        fstream file;
        Song* p = NULL;
    ...
    void playMusic(PNode* p) {
        ...
        cout << "Press 0 to replay/resume,1 to pause,2 to set/reset loop,3 to forward,4 to backward and 5 to exit." << endl << endl;
        char temp;
        int check = 0;
        int choice = -1;
        music.play();
...
void playMusic(Song &song,Hash &h) {
    ...
    song.display();
    cout << "Song duration = " << duration(music.getDuration().asSeconds()) << endl << endl;
    cout << "Press 0 to play/replay/resume,1 to pause,2 to stop,3 to add to a playlist and 4 to exit." << endl << endl;
    char temp;
    int choice=-1;
    while (choice!=4) {
        while (!_kbhit()) {
...
void playlistMenu(Hash& h) {
    ...
    int num,choice;
    fstream file;
    file.open("D:\\Code\\DS\\DS Theory Project\\Text Files\\Playlists.txt",ios::in);
    if (!file) {
        mainMenu(h);
    }
    getline(file, line);
...
bool createPlaylist(string *arr,int size) {
    ...
    fstream file;
    file.open("D:\\Code\\DS\\DS Theory Project\\Text Files\\" + str + ".txt", ios::out);
    if (!file) {
        return 0;
    }
    file.close();
    file.open("D:\\Code\\DS\\DS Theory Project\\Text Files\\Playlists.txt", ios::out);
    if (!file) {
        return 0;
    }
    file << size + 1 << endl;
...
void updateRecentlyPlayed(string name) {
    string line;
    fstream file;
    file.open("D:\\Code\\DS\\DS Theory Project\\Text Files\\Recently Played.txt", ios::in);
    if (!file) {
        return;
    }
    Stack s1,s2;
    ...
    file.open("D:\\Code\\DS\\DS Theory Project\\Text Files\\Recently Played.txt", ios::out);
    while (!s2.isEmpty()) {
        file << s2.pop() << endl;
    }
    file.close();
...
void genreMenu(Hash &h1) {
    string line;
    fstream file;
    file.open("D:\\Code\\DS\\DS Theory Project\\Text Files\\Genre.txt", ios::in);
    if (!file) {
        return;
    }
    Tree tree;
...
void loadData() {
    string line;
    ifstream in("D:\\Code\\DS\\DS Theory Project\\Text Files\\Songs.txt");
    if (!in) {
        return;
    }
    getline(in, line);
